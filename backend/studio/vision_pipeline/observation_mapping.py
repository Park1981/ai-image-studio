...
# TODO(Recall Phase 3): face_detail / object_interaction / clothing_detail /
# crowd_detail 새 슬롯 (vision_observe.py Phase 1 에 추가됨) 읽기 추가.
# 현재는 옛 슬롯 (expression / clothing[] / pose 등) 만 매핑함.
