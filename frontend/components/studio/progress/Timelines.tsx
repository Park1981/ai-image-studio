 ...
 *
 * Generate (6 stage) / Video (5 step) 각각 store 직접 구독.
 * TimelineRow + DetailBox 는 3 모드 공유.
 *
 * 2026-04-27 (Phase 2 진행 모달 store 통일):
 *   EditTimeline 제거 → ProgressModal 에서 PipelineTimeline mode="edit" 로 교체.
 *   Generate/Video 는 Phase 3 에서 통일 (VideoTimeline 만 남음).
 */
 ...
 *   ProgressModal 이 직접 PipelineTimeline 호출 — 옛 EditTimeline 함수 제거. */
